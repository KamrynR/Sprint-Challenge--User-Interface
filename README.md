...
Semantic HTML is making the code more legible to Humans.
2. What are the 4 areas of the box model?
Margins, Padding, Borders, and Content
3. While using flexbox, what axis does the following property work on: ```align-items: center```?
Verticle Axis
4. Explain why git is valuable to a team of developers.
Git allows branching and easier collaboration.
5. Define mobile-first design in your own words.
Mobile first design lets your website reach phones which are a very large portion of internet usage.
